...
class EmployeeManagementSystem:
    ...
    def data_cleaning(self):
        # Implement the logic for data cleaning
        # For example, you can show a message box or perform some operations
        messagebox.showinfo("Data Cleaning", "Performing Data Cleaning")

    def data_information(self):
    # Implement the logic for data information
    # For example, you can show a message box or perform some operations
        messagebox.showinfo("Data Information", "Displaying Data Information")

    def data_visualization(self):
        # Implement the logic for data visualization
        # For example, you can show a message box or create visualizations
        messagebox.showinfo("Data Visualization", "Creating Data Visualization")

    def statistic_of_data(self):
        # Implement the logic for statistic of data
        # For example, you can show a message box or calculate statistics
